      ...
      <div class="container">
        ...
        <div class="row mixed-row">
          ...
          <div class="field grow">
            ...
            <input class="input" name="region" type="text" />
          </div>
          <div class="field grow">
            <label class="input-label">Account</label>
            <input class="input" name="account" type="text" />
          </div>
        </div>
        <div class="row mixed-row">
          <div class="field grow">
          ...
          <div class="field grow">
            ...
            <input class="input" name="warehouse" type="text" />
          </div>
          <div class="field grow">
            <label class="input-label">Schema</label>
            <input class="input" name="schema" type="text" />
          </div>
        </div>
        <div class="row mixed-row">
          <div class="field grow">
          ...
          <div class="field grow">
            <label class="input-label">Public Key Fingerprint</label>
            <input class="input" name="public_key_fingerprint" type="text" />
          </div>
        </div>
      </div>
    </div>
